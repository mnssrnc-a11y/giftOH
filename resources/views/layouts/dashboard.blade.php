@extends('app')
@section('body')
<div class="hope-shell" data-user-id="{{ auth()->id() }}">
...
<a href="{{ route('admin') }}"><span aria-hidden="true">⚙</span>Admin workspace</a>
@endif
@if(in_array(auth()->user()->role, ['admin', 'superadmin'], true))
<a href="{{ route('superadmin') }}"><span aria-hidden="true">◇</span>Superadmin workspace</a>
@endif
</nav>
