                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 15px; margin: 0 0 28px 0; line-height: 1.6;">
                                Hi <strong style="color: #374151;">{{ $fName }}</strong>, you recently attempted to log in to your Gift of Hope account. Use the code below to complete your authentication:
                            </p>
                            ...
                            <p style="color: #6b7280; font-size: 14px; margin: 0; line-height: 1.6;">
                                If you didn't attempt to sign in, please secure your account or change your password immediately.
                            </p>
                        </td>
                    </tr>
