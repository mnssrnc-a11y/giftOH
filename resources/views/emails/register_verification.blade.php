                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 15px; margin: 0 0 28px 0; line-height: 1.6;">
                                Hi <strong style="color: #374151;">{{ $fName }}</strong>, thank you for registering with Gift of Hope! Please use the code below to verify your email address and complete your registration:
                            </p>
