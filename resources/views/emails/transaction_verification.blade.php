                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 15px; margin: 0 0 28px 0; line-height: 1.6;">
                                Hi <strong style="color: #374151;">{{ $fName }}</strong>, you are submitting a new fund request transaction. Use the OTP code below to verify and complete your submission:
                            </p>
                            ...
                            <p style="color: #6b7280; font-size: 14px; margin: 0; line-height: 1.6;">
                                If you didn't initiate this fund request, please ignore this email.
                            </p>
                        </td>
                    </tr>
