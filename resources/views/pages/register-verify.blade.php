...
@section('title', 'Verify Email - Gift of Hope')
        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                ...
                <form method="POST" action="{{ route('register.verify-code') }}">
                    ...
                    <button type="submit" class="w-full bg-[#1E3A8A] text-white py-3 rounded-lg font-bold hover:bg-[#2d4a9e] transition-colors flex items-center justify-center gap-2">Verify & Complete Registration</button>
                </form>
                ...
                <div class="mt-6 text-center space-y-2">
                    ...
                    <p class="text-sm text-gray-500">
                        <a href="{{ route('register') }}" class="text-gray-500 hover:underline">← Back to Registration</a>
                    </p>
                </div>
            </div>
            <div class="mt-6 text-center">
                ...
                <div class="mt-4">
                    <a href="{{ route('register') }}" class="text-[#3B82F6] font-semibold hover:underline text-sm">← Back to Registration</a>
                </div>
            </div>
        </div>
    </div>
