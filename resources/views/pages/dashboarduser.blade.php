        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex items-center grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <!-- <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-600 text-sm font-semibold mb-2">Total Donations</p>
                    ...
                    <a href="{{ route('donations') }}" class="mt-4 inline-block w-full text-center bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 transition-colors text-sm font-semibold">
                        View Donations
                    </a>
                </div> -->
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('donations') }}" class="flex items-center gap-3 p-4 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">
                                <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
